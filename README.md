# ROS 2 Humble Drone with TFmini-S LiDAR Wall Detection and MAVROS Control

**Platform:** Radxa Rock 5C (Debian 12 KDE B1)  
...
### Hardware
- Radxa Rock 5C (Debian 12 KDE B1)
...
## 2️⃣ Install ROS 2 Humble on Debian 12
...
sudo sh -c 'echo "deb [arch=amd64,arm64 signed-by=/usr/share/keyrings/ros-archive-keyring.gpg] http://packages.ros.org/ros2/ubuntu $(lsb_release -cs) main" > /etc/apt/sources.list.d/ros2.list'
...
- Ensure serial port (`/dev/ttyS2`) matches your connection to TFmini-S.
...
- Fully **documented and reusable** on Radxa Rock 5C Debian 12 KDE.
